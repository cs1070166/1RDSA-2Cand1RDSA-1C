...
%
function hadamardpert_1s(p, sigma, type, numSimulations, replications, theta_0)
...
% inner loop runs 1SPSA for numIterations (each iter=2 function evals)
  ...
  % ck=0.01
    ...
    Hadamard_Results_1sim(k+1,i)=(theta-thetaStar)'*(theta-thetaStar)/mseTheta0;
