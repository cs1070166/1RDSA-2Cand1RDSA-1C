...
% disp('---------------1SPSA_depnbern---------------');
% onespsa_depnbern(p, sigma, type, numSimulations, replications, theta_0);
 

% disp('---------------asynch_onefdsa---------------');
% asynch_onefdsa(p, sigma, type, numSimulations, replications, theta_0);


% disp('---------------1FDSA---------------');
% onefdsa(p, sigma, type, numSimulations, replications, theta_0);
 
% disp('---------------c_1RDSA---------------');
% coordinate_onefdsa(p, sigma, type, numSimulations, replications, theta_0);

% disp('---------------1RDSA-Unif---------------');
% onerdsa_unif(p, sigma, type, numSimulations, replications, theta_0);

% disp('---------------1RDSA-AsymBer---------------');
% run1rdsa(p, sigma, type, numSimulations, replications, theta_0);

% disp('---------------1SPSAWithfb---------------');
% onespsaWithfb(p, sigma, type, numSimulations, replications, theta_0);
 
% disp('---------------MOMENTUMSPSA---------------');
% momentumspsa(p, sigma, type, numSimulations, replications, theta_0);

 
% disp('---------------myMOMENTUMSPSA---------------');
% myMomentumspsa(p, sigma, type, numSimulations, replications, theta_0);

% 
% disp('---------------MOMENTUMRDSA_unif---------------');
% momentumrdsa_unif(p, sigma, type, numSimulations, replications, theta_0);
