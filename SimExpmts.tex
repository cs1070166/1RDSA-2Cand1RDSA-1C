...
&\\
\textbf{1RDSA-2C}& \bm{$3.598 \times 10^{-3} \pm 4.158 \times 10^{-4}$}\\
 \bottomrule
...
\textbf{1SPSA-2R} &$2.747 \times 10^{-2} \pm 1.413 \times 10^{-2}$ \\
&\\
\textbf{1SPSA-2H} &$3.901 \times 10^{-3} \pm 4.359 \times 10^{-18}$ \\ 
&\\
\textbf{1RDSA-2C} &\bm{$3.535 \times 10^{-3} \pm 1.743 \times 10^{-18}$}\\
 \bottomrule
\end{tabular}
}
\end{table}
